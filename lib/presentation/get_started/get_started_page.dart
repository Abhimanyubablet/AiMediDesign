      ...
      onHorizontalDragEnd: (details) {
        if (details.primaryVelocity! > 0) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => LandingPageFirst()), // Navigate to Screen3
          );
        }
      },
      child: Scaffold(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(
                        'assets/images/smart_health_logo.png'), // Set the image path
                   ...
                   SizedBox(height: 15,),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Colors.black, width: 1), // Define border properties
                      ),
                      child: Material(
                        borderRadius: BorderRadius.circular(10), // Match the outer container's border radius
